var kaboom = (() => {
  ...
  var jt = (i, t, l) =>
      t in i
        ? Ge(i, t, { enumerable: !0, configurable: !0, writable: !0, value: l })
        : (i[t] = l),
    P = (i, t) => {
      for (var l in t || (t = {})) or.call(t, l) && jt(i, l, t[l]);
      if (sr) for (var l of sr(t)) es.call(t, l) && jt(i, l, t[l]);
      return i;
    },
    D = (i, t) => zi(i, Qi(t)),
    a = (i, t) => Ge(i, "name", { value: t, configurable: !0 });
  var ar = (i, t) => {
      for (var l in t) Ge(i, l, { get: t[l], enumerable: !0 });
    },
    ts = (i, t, l, w) => {
  ...
  var ns = (i) => ts(Ge({}, "__esModule", { value: !0 }), i);
  ...
  function B(i, t) {
    cr.has(i) ||
      (cr.add(i), console.warn(`${i} is deprecated. Use ${t} instead.`));
  }
  a(B, "deprecateMsg");
  var T = a(
    (i, t, l) =>
  ...
  var N = class {
      ...
      lerp(t, l) {
        return new N(Be(this.x, t.x, l), Be(this.y, t.y, l));
      }
      toFixed(t) {
  ...
  a(E, "rgb");
  var mr = a((i, t, l) => v.fromHSL(i, t, l), "hsl2rgb"),
    V = class {
      constructor(t, l, w, U) {
        b(this, "x", 0);
        b(this, "y", 0);
  ...
  var R = class {
    ...
    invert() {
      let t = [],
        ...
        cn = this.m[5] * this.m[15] - this.m[13] * this.m[7],
        vt = this.m[4] * this.m[13] - this.m[12] * this.m[5],
        Et = this.m[6] * this.m[11] - this.m[10] * this.m[7],
        Se = this.m[5] * this.m[11] - this.m[9] * this.m[7],
        Ce = this.m[5] * this.m[10] - this.m[9] * this.m[6],
        Re = this.m[4] * this.m[11] - this.m[8] * this.m[7],
        J = this.m[4] * this.m[10] - this.m[8] * this.m[6],
        Ke = this.m[4] * this.m[9] - this.m[8] * this.m[5];
      (t[0] = this.m[5] * l - this.m[6] * w + this.m[7] * U),
        ...
        (t[2] = this.m[1] * q - this.m[2] * k + this.m[3] * j),
        (t[6] = -(this.m[0] * q - this.m[2] * X + this.m[3] * $)),
        (t[10] = this.m[0] * cn - this.m[1] * X + this.m[3] * vt),
        (t[14] = -(this.m[0] * j - this.m[1] * $ + this.m[2] * vt)),
        (t[3] = -(this.m[1] * Et - this.m[2] * Se + this.m[3] * Ce)),
        (t[7] = this.m[0] * Et - this.m[2] * Re + this.m[3] * J),
        (t[11] = -(this.m[0] * Se - this.m[1] * Re + this.m[3] * Ke)),
        (t[15] = this.m[0] * Ce - this.m[1] * J + this.m[2] * Ke);
      let Tt =
        this.m[0] * t[0] +
        this.m[1] * t[4] +
        this.m[2] * t[8] +
      ...
      for (let We = 0; We < 4; We++)
        for (let Me = 0; Me < 4; Me++) t[We * 4 + Me] *= 1 / Tt;
      return new R(t);
    }
    toString() {
  ...
  var is = 1103515245,
    ...
    pe = class {
      ...
      gen(...t) {
        if (t.length === 0)
          return (this.seed = (is * this.seed + ss) % fr), this.seed / fr;
        if (t.length === 1) {
  ...
  a(he, "testLineLine");
  function pt(i, t) {
    return ue(i, t.p1) || ue(i, t.p2)
      ? !0
      : !!he(t, new ae(i.p1, f(i.p2.x, i.p1.y))) ||
          !!he(t, new ae(f(i.p2.x, i.p1.y), i.p2)) ||
          !!he(t, new ae(i.p2, f(i.p1.x, i.p2.y))) ||
          !!he(t, new ae(f(i.p1.x, i.p2.y), i.p1));
  }
  a(pt, "testRectLine");
  function ue(i, t) {
  ...
  a(Tr, "testLineCircle");
  function je(i, t) {
    if (Ee(t, i.p1) || Ee(t, i.p2)) return !0;
    for (let l = 0; l < t.length; l++) {
      let w = t[l],
        U = t[(l + 1) % t.length];
      if (he(i, { p1: w, p2: U })) return !0;
    }
    return !1;
  }
  a(je, "testLinePolygon");
  function wt(i, t) {
  ...
  function Ee(i, t) {
    ...
    for (let w = 0, U = i.length - 1; w < i.length; U = w++)
      i[w].y > t.y != i[U].y > t.y &&
        t.x <
          ((i[U].x - i[w].x) * (t.y - i[w].y)) / (i[U].y - i[w].y) + i[w].x &&
        (l = !l);
    return l;
  }
  ...
  var Ls = a((i = {}) => {
    let t = (() => {
      ...
      l = (() => {
        ...
        e.bindBuffer(e.ARRAY_BUFFER, c),
          e.vertexAttribPointer(0, 3, e.FLOAT, !1, $e * 4, 0),
          e.enableVertexAttribArray(0),
          e.vertexAttribPointer(1, 2, e.FLOAT, !1, $e * 4, 12),
          e.enableVertexAttribArray(1),
          e.vertexAttribPointer(2, 4, e.FLOAT, !1, $e * 4, 20),
    ...
    let w = (() => {
      ...
      p = {
        ...
        scenes: {},
        logs: [],
        cam: { pos: ut(), scale: f(1), angle: 0, shake: 0, transform: new R() },
      };
    function S(e) {
      return (
        U.numLoading++,
    ...
    function X(e, n, r, u, c = {}) {
      return S(
        j(n).then((s) => {
          var d;
          let o = jr(ze(s, c), r, u, (d = c.chars) != null ? d : Or);
    ...
    function Se(e = 1, n = 1, r = 0, u = 0, c = 1, s = 1) {
      let o = [],
        ...
        h = s / n;
      for (let m = 0; m < n; m++)
        for (let g = 0; g < e; g++) o.push(new V(r + g * d, u + m * h, d, h));
      return o;
    }
    a(Se, "slice");
    function Ce(e, n) {
        ...
        new Promise((r, u) => {
          ...
          typeof n == "string" &&
            k(n)
              ...
              .then(
                (c) => new Promise((s, o) => w.ctx.decodeAudioData(c, s, o))
              )
              .then((c) => {
                let s = { buf: c };
                e && (U.sounds[e] = s), r(s);
    ...
    a(Nr, "volume");
    function He(e, n = { loop: !1, volume: 1, speed: 1, detune: 0, seek: 0 }) {
      var g;
      if (typeof e == "string") {
        let y = He({ buf: _r() });
        return (
      ...
      let d = r.currentTime - o,
        ...
        m = {
          ...
          volume(y) {
            return y !== void 0 && (s.gain.value = z(y, Ir, Vr)), s.gain.value;
          },
          loop() {
            c.loop = !0;
          },
    ...
    function hn(e = an, n = un) {
      let r = t.gl,
        u,
        c = Es.replace("{{user}}", e != null ? e : an),
        s = Ts.replace("{{user}}", n != null ? n : un),
...
`)
    ...
    function St(e, n, r, u = l.defTex, c = l.defShader, s = {}) {
      ...
      for (let o of n) l.iqueue.push(o + l.vqueue.length / $e - e.length);
      ...
      t.gl.clear(t.gl.COLOR_BUFFER_BIT),
        i.background ||
          me({
            width: F(),
            height: G(),
            quad: new V(0, 0, (F() * t.scale) / Fr, (G() * t.scale) / Fr),
            tex: l.bgTex,
            fixed: !0,
          }),
        (l.drawCalls = 0),
    ...
    function me(e) {
      ...
      let n = e.width,
        r = e.height,
        c = Xe(e.origin || Ye).scale(f(n, r).scale(-0.5)),
        s = e.quad || new V(0, 0, 1, 1),
    ...
    function $r(e) {
      ...
      let n = (s = e.quad) != null ? s : new V(0, 0, 1, 1),
        r = e.tex.width * n.w,
        u = e.tex.height * n.h,
        c = f(1);
      if (e.tiled) {
    ...
    function fn(e) {
      ...
      $r(
        D(P({}, e), {
          tex: n.tex,
          quad: r.scale(e.quad || new V(0, 0, 1, 1)),
          uniform: e.uniform,
        })
      );
    }
    ...
    function Q(e) {
      ...
      if (e.radius) {
        ...
        s = [
          f(o, 0),
          f(n - o, 0),
          ...Le(f(n - o, o), o, o, 270, 360),
          f(n, o),
          f(n, r - o),
          ...Le(f(n - o, r - o), o, o, 0, 90),
          f(n - o, r),
          f(o, r),
          ...Le(f(o, r - o), o, o, 90, 180),
          f(0, r - o),
          f(0, o),
          ...Le(f(o, o), o, o, 180, 270),
        ];
      }
      et(D(P({}, e), { offset: c, pts: s }));
    }
    a(Q, "drawRect");
    function qe(e) {
      let { p1: n, p2: r } = e;
    ...
    function mn(e) {
      ...
      return et(D(P({}, e), { pts: [e.p1, e.p2, e.p3] }));
    }
    a(mn, "drawTriangle");
    function Rt(e) {
      if (!e.radius)
      ...
      e.radius !== 0 &&
        wn(D(P({}, e), { radiusX: e.radius, radiusY: e.radius, angle: 0 }));
    }
    a(Rt, "drawCircle");
    function wn(e) {
      var n, r;
    ...
    function et(e) {
      ...
      if (!(n < 3)) {
        if (
          (re(), I(e.pos), ne(e.scale), Ze(e.angle), I(e.offset), e.fill !== !1)
        ) {
    ...
    function we(e) {
      ...
      let n = yn((er = e.font) != null ? er : i.font, U.fonts, vs);
      ...
      let { charStyleMap: r, text: u } = Xr(e.text + ""),
        ...
        m = h.x * s + ((tr = e.letterSpacing) != null ? tr : 0),
        g = h.y * o + ((nr = e.lineSpacing) != null ? nr : 0),
        y = 0,
        x = g,
        W = 0,
        O = [],
...
` && (M.push(oe), (y += m), oe === " " && (ee = M.length)),
      ...
      let Ve = [],
        ke = f(e.pos || 0),
        _ = Xe(e.origin || Ye).scale(0.5),
        se = -_.x * m - (_.x + 0.5) * (W - m),
        Fe = -_.y * g - (_.y + 0.5) * (x - g),
        lt = 0;
      return (
        O.forEach((oe, Ni) => {
          ...
          oe.forEach((ht, Yi) => {
            ...
            if (_t) {
              let Bt = {
                tex: n.tex,
                quad: new V(_t.x, _t.y, n.qw, n.qh),
                ch: ht,
                pos: f(ke.x + $i + se + ji, ke.y + Xi + Fe),
                opacity: e.opacity,
                color: (rr = e.color) != null ? rr : E(255, 255, 255),
                scale: h,
                angle: 0,
                uniform: e.uniform,
                fixed: e.fixed,
              ...
              if (r[lt]) {
                let { styles: dt, localIdx: Ki } = r[lt];
                for (let Hi of dt) {
                  let Nt = e.styles[Hi],
                    ir = typeof Nt == "function" ? Nt(Ki, ht) : Nt;
                  ir && gn(Bt, ir);
                }
              }
              Ve.push(Bt);
    ...
    let C = {
      ...
      clearLog: () => (p.logs = []),
      log: (e) => p.logs.unshift(`[${it().toFixed(2)}].time [${e}].info`),
      error: (e) => p.logs.unshift(`[${it().toFixed(2)}].time [${e}].error`),
      curRecording: null,
      get paused() {
        return t.paused;
      },
          ...
          get(s) {
            return this.children
              ...
              .sort((o, d) => {
                var g, y, x, W, O, M;
                let h =
                    (y = p.layers[(g = o.layer) != null ? g : p.defLayer]) !=
                    null
                      ? y
                      : 0,
                  m =
                    (W = p.layers[(x = d.layer) != null ? x : p.defLayer]) !=
                    null
                      ? W
                      : 0;
                return h == m
    ...
    function Ae(e, n, r) {
      return (
        p.objEvents[e] || (p.objEvents[e] = new Y()),
    ...
    function Oe(e, n) {
      ...
      if (typeof e == "string") return Ae("update", e, n);
    }
    a(Oe, "onUpdate");
    function Cn(e, n) {
      if (typeof e == "function" && n === void 0) return p.root.onDraw(e);
      if (typeof e == "string") return Ae("draw", e, n);
    }
    a(Cn, "onDraw");
    function Rn(e, n, r) {
      let u = Ae("collide", e, (o, d, h) => d.is(n) && r(o, d, h)),
        c = Ae("collide", n, (o, d, h) => d.is(e) && r(d, o, h)),
        s = Oe(e, (o) => {
          if (!o.area)
            throw new Error(
    ...
    function ot(...e) {
      return {
          ...
          if (
            ...
            p.root.every((h) => {
              ...
              if (
                ...
                h === this ||
                !h.solid ||
                ((ke = h.area) == null ? void 0 : ke.shape) !== "rect"
              )
                return;
              let m = h.worldArea(),
                g = bt(m, d);
          ...
          return (
            ...
            s &&
              ...
              s.target.trigger(
                "collide",
                this,
                _n(this, s.displacement.scale(-1))
              )),
            s
          );
        },
        ...
        screenPos() {
          return this.fixed ? this.pos : st(this.pos);
        },
        inspect() {
        ...
        : {
            ...
            inspect() {
              return typeof this.scale == "number"
                ? `${Ue(this.scale, 2)}`
                : `(${Ue(this.scale.x, 2)}, ${Ue(this.scale.y, 2)})`;
            },
          };
    }
    a(at, "scale");
      ...
      return {
        ...
        isOutOfView() {
          ...
          let u = f((s = e.offset) != null ? s : 0),
            c = new ve(f(0, 0).sub(u), f(F(), G()).add(u));
    ...
    function pi(e = {}) {
      ...
      return {
        ...
        screenArea() {
          ...
          return this.fixed ? c : { shape: "rect", p1: st(c.p1), p2: st(c.p2) };
        },
      };
    }
    a(pi, "area");
      ...
      return (
        a(c, "calcTexScale"),
        {
              ...
              (u = {
                ...
                pingpong:
                  (x = (y = d.pingpong) != null ? y : h.pingpong) != null
                    ...
                    : !1,
                speed:
                  (O = (W = d.speed) != null ? W : h.speed) != null ? O : 10,
          ...
          inspect() {
            let o = "";
            return (
              typeof e == "string" ? (o += JSON.stringify(e)) : (o += "[blob]"),
              o
            );
          },
        }
    ...
    function Ui(e) {
      return {
        ...
        radius: e,
        draw() {
          Rt(D(P({}, Ie(this)), { radius: this.radius }));
        },
        inspect() {
    ...
    function jn(e) {
      let n = e(be);
      for (let r in n) (be[r] = n[r]), i.global !== !1 && (window[r] = n[r]);
      return be;
    }
    a(jn, "plug");
    function ut() {
      ...
      return (
        ...
        s.start(),
        {
          ...
          download(d = "kaboom.mp4") {
            (s.onstop = () => {
              lr(new Blob(o, { type: "video/mp4" }), d);
            }),
              s.stop(),
    ...
    function Xn(e = 2, n = 1) {
      ...
      return {
        ...
        update() {
          ...
          u < 0 && ct(this), (this.scale = f(u)), (r += Z());
        },
      };
    }
    a(Xn, "explode");
    let Kn = null,
      Hn = null;
    J(null, qr).then((e) => (Kn = e)), J(null, Pr).then((e) => (Hn = e));
    function Gi(e, n = {}) {
      var o, d;
      let r = (n.speed || 1) * 5,
        u = n.scale || 1,
    ...
    function _i() {
      let e = p.cam,
        n = L.fromAngle(Ne(0, 360)).scale(e.shake);
      (e.shake = Be(e.shake, 0, 5 * Z())),
        (e.transform = new R()
          .translate(ut())
          .scale(e.scale)
          .rotateZ(e.angle)
...
`),
    ...
    function Zn(e) {
      let n = a((r) => {
        ...
        for (let s in t.mouseStates) t.mouseStates[s] = Gr(t.mouseStates[s]);
        (t.charInputted = []),
          (t.isMouseMoved = !1),
          (t.isKeyPressed = !1),
    ...
    let be = {
      ...
      keyIsPressed: T("keyIsPressed()", "isKeyPressed()", De),
      keyIsPressedRep: T("keyIsPressedRep()", "isKeyPressedRepeat()", Mt),
      keyIsReleased: T("keyIsReleased()", "isKeyReleased()", rt),
      mouseIsDown: T("mouseIsDown()", "isMouseDown()", tt),
      mouseIsClicked: T("mouseIsClicked()", "isMousePressed()", Pe),
      mouseIsReleased: T("mouseIsReleased()", "isMouseReleased()", nt),
      mouseIsMoved: T("mouseIsMoved()", "isMouseMoved()", Wt),
      dir: T("dir()", "Vec2.fromAngle()", L.fromAngle),
      action: T("action()", "onUpdate()", Oe),
      render: T("render()", "onDraw()", Cn),
      collides: T("collides()", "onCollide()", Rn),
      clicks: T("clicks()", "onClick()", Wn),
      hovers: T("hovers()", "onHover()", Mn),
      ...
      mouseDown: T("mouseDown()", "onMouseDown()", qn),
      mouseClick: T("mouseClick()", "onMousePress()", Ot),
      mouseRelease: T("mouseRelease()", "onMouseRelease()", Pn),
      mouseMove: T("mouseMove()", "onMouseMove()", Dn),
      charInput: T("charInput()", "onCharInput()", An),
      touchStart: T("touchStart()", "onTouchStart()", On),
      touchMove: T("touchMove()", "onTouchMove()", In),
      touchEnd: T("touchEnd()", "onTouchEnd()", Vn),
      focused: T("focused()", "isFocused()", $n),
      ready: T("ready()", "onLoad()", ye),
    };
    if ((i.plugins && i.plugins.forEach(jn), i.global !== !1))
      for (let e in be) window[e] = be[e];
    return be;
  }, "default");
  return ns(qs);
})();
