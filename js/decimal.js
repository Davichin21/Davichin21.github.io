...
!(function (r) {
  ...
  function e(r, e) {
    ...
    if (
      ((f = r.d), (c = e.d), (s = r.e), (i = e.e), (f = f.slice()), (o = s - i))
    ) {
      for (
        0 > o
          ? ((n = f), (o = -o), (u = c.length))
  ...
  function c(r, e) {
    ...
    for (
      (t = e.indexOf(".")) > -1 && (e = e.replace(".", "")),
        (n = e.search(/e/i)) > 0
          ? (0 > t && (t = n), (t += +e.slice(n + 1)), (e = e.substring(0, n)))
          : 0 > t && (t = e.length),
        n = 0;
      48 === e.charCodeAt(n);
  ...
  function l(r, e) {
    ...
    if (
      ((f = r.d), (d = e.d), (n = e.e), (c = r.e), (f = f.slice()), (s = c - n))
    ) {
      for (
        l = 0 > s,
          l
    ...
    return (
      e
        ? (t && (i = t - c) > 0
          ...
          (f = f + (0 > s ? "e" : "e+") + s))
        : 0 > s
        ? ((f = "0." + u(-s - 1) + f), t && (i = t - c) > 0 && (f += u(i)))
        : s >= c
        ? ((f += u(s + 1 - c)),
          t && (i = t - s - 1) > 0 && (f = f + "." + u(i)))
        : ((i = s + 1) < c && (f = f.slice(0, i) + "." + f.slice(i)),
          t && (i = t - c) > 0 && (s + 1 === c && (f += "."), (f += u(i)))),
      r.s < 0 ? "-" + f : f
    );
  }
  function a(r, e) {
  ...
  function g(r) {
    function e(r) {
      ...
      if (((t.constructor = e), r instanceof e))
        return (t.s = r.s), (t.e = r.e), void (t.d = (r = r.d) ? r.slice() : r);
      if ("number" == typeof r) {
      ...
      if (
        (45 === r.charCodeAt(0) ? ((r = r.slice(1)), (t.s = -1)) : (t.s = 1),
        !D.test(r))
      )
        throw Error(x + r);
      c(t, r);
    ...
    if (
      ...
      for (
        i = ["precision", "rounding", "toExpNeg", "toExpPos", "LN10"], t = 0;
        t < i.length;
  ...
  (A.absoluteValue = A.abs =
    ...
    (A.comparedTo = A.cmp =
      function (r) {
        ...
        for (
          ...
          if (o.d[e] !== r.d[e]) return (o.d[e] > r.d[e]) ^ (o.s < 0) ? 1 : -1;
    ...
    (A.logarithm = A.log =
      function (r) {
        ...
        else if (((r = new n(r)), r.s < 1 || r.eq(v))) throw Error(N + "NaN");
        if (t.s < 1) throw Error(N + (t.s ? "NaN" : "-Infinity"));
        return t.eq(v)
          ? new n(0)
          : ((E = !1), (e = P(f(t, o), f(r, o), o)), (E = !0), h(e, i));
      }),
    (A.minus = A.sub =
      function (r) {
        var t = this;
    ...
    (A.modulo = A.mod =
      function (r) {
        ...
        return t.s
          ? ((E = !1), (e = P(t, r, 0, 1).times(r)), (E = !0), t.minus(e))
          : h(new n(t), i);
      }),
    ...
    (A.precision = A.sd =
      function (r) {
        ...
        if (
          ((e = o(i) + 1), (n = i.d.length - 1), (t = n * y + 1), (n = i.d[n]))
        ) {
          for (; n % 10 == 0; n /= 10) t--;
    ...
    (A.times = A.mul =
      function (r) {
        ...
        for (; !o[--s]; ) o.pop();
        return (
          e ? ++t : o.shift(), (r.d = o), (r.e = t), E ? h(r, d.precision) : r
        );
      }),
        ...
        if (((e = r.e), (t = r.d.length - 1), (u = e >= t), (s = c.s), u)) {
          if ((t = 0 > g ? -g : g) <= M) {
            for (
              ...
              t % 2 && ((o = o.times(c)), a(o.d, e)), (t = b(t / 2)), 0 !== t;
    ...
    (A.toPrecision = function (r, e) {
      ...
      return (
        void 0 === r
          ? ((n = o(s)), (i = d(s, n <= u.toExpNeg || n >= u.toExpPos)))
          : (t(r, 1, w),
            void 0 === e ? (e = u.rounding) : t(e, 0, 8),
            (s = h(new u(s), r, e)),
            (n = o(s)),
      ...
      function (r, e) {
        ...
        return (
          void 0 === r
            ...
            : (t(r, 1, w), void 0 === e ? (e = i.rounding) : t(e, 0, 8)),
          h(new i(n), r, e)
        );
      }),
    (A.toString =
  ...
  var P = (function () {
    ...
    function t(r, e, t) {
      for (var n = 0; t--; )
        (r[t] -= n), (n = r[t] < e[t] ? 1 : 0), (r[t] = n * q + r[t] - e[t]);
    ...
    return function (n, i, s, u) {
      ...
      if (((x = (x / y + 2) | 0), (l = 0), 1 == M))
        for (d = 0, U = U[0], x++; (L > l || d) && x--; l++)
          (O = d * q + (R[l] || 0)), (v[l] = (O / U) | 0), (d = O % U | 0);
      else {
        for (
          d = (q / (U[0] + 1)) | 0,
            d > 1 &&
              ((U = r(U, d)), (R = r(R, d)), (M = U.length), (L = R.length)),
            b = M,
            w = R.slice(0, M),
            m = w.length;
          M > m;
